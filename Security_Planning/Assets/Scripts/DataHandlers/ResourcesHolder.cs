...
namespace Assets.Scripts.DataHandlers
{
    /// <summary>
    /// Singleton holding resources so that they are loaded just once.
    /// </summary>
    public class ResourcesHolder
    {
        ...
        private static readonly string[] BASIC_ENTITIES_NAMES = {"Burglar", "Guard"};

        public static ResourcesHolder Instance
        {
            get { return instance ?? (instance = new ResourcesHolder()); }
        }

        /// <summary>
        /// Return Guard and Burglar.
        /// </summary>
        public IEnumerable<Object> BasicEntities
        {
            get { return AllEntities.Where(entity => BASIC_ENTITIES_NAMES.Contains(entity.name)); }
        }
